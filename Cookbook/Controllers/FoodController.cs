    ...
    public class FoodController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                ...
                var json = client.DownloadString("http://cookbookapi-6.apphb.com/api/MonAn/LayMonAn/" + id.ToString());
        ...
        public ActionResult POST(HttpPostedFileBase file)
        {
            ...
            //Upload hinh
            Account account = new Account("hjzejblv4", "544763883541154", "p355aNfEANREUlj2LpLMkthGt1Y");
